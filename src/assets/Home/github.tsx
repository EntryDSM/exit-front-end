export default function GithubIcon() {
  return (
    ...
    >
      <rect width="26" height="26" rx="6" fill="url(#pattern0)" />
      <defs>
        <pattern
          id="pattern0"
